 ...
 * @author David Henn
 * @date 1.3.2011
 * This interface provides methods to retrieve entities from the database
 */
...
public interface ILogicEntityProvider {
	...
	/**
	 * 
	 * @param startDate entities from this date
	 ...
	 * @param endDate to this date
	 * @param tags entities which are tagged with the tags in this list
	 * @return all entities between the given start and end date, which are tagged with the given tags
	 */
	public List<Entity> getEntities(Date startDate, Date endDate, List<Tag>tags);
	
	/**
	 * 
	 * @param tags the tags with which the entities should be tagged
